...
func (tu *TodoUpdate) SetAssaginPerson(s string) *TodoUpdate {
	tu.mutation.SetAssaginPerson(s)
	return tu
}
...
func (tu *TodoUpdate) SetIsComplete(b bool) *TodoUpdate {
	tu.mutation.SetIsComplete(b)
	return tu
}

// SetNillableIsComplete sets the "is_complete" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableIsComplete(b *bool) *TodoUpdate {
	if b != nil {
		tu.SetIsComplete(*b)
	}
	return tu
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.AssaginPerson(); ok {
		_spec.SetField(todo.FieldAssaginPerson, field.TypeString, value)
	}
...
// SetAssaginPerson sets the "assagin_person" field.
func (tuo *TodoUpdateOne) SetAssaginPerson(s string) *TodoUpdateOne {
	tuo.mutation.SetAssaginPerson(s)
	return tuo
}
...
// SetIsComplete sets the "is_complete" field.
func (tuo *TodoUpdateOne) SetIsComplete(b bool) *TodoUpdateOne {
	tuo.mutation.SetIsComplete(b)
	return tuo
}

// SetNillableIsComplete sets the "is_complete" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableIsComplete(b *bool) *TodoUpdateOne {
	if b != nil {
		tuo.SetIsComplete(*b)
	}
	return tuo
...
func (tuo *TodoUpdateOne) sqlSave(ctx context.Context) (_node *Todo, err error) {
	...
	if value, ok := tuo.mutation.AssaginPerson(); ok {
		_spec.SetField(todo.FieldAssaginPerson, field.TypeString, value)
	}
