...
// SetAssaginPerson sets the "assagin_person" field.
func (m *TodoMutation) SetAssaginPerson(s string) {
	m.assagin_person = &s
}

// AssaginPerson returns the value of the "assagin_person" field in the mutation.
func (m *TodoMutation) AssaginPerson() (r string, exists bool) {
	v := m.assagin_person
	if v == nil {
		return
	}
...
// OldAssaginPerson returns the old "assagin_person" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldAssaginPerson(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAssaginPerson is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldAssaginPerson requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldAssaginPerson: %w", err)
	}
	return oldValue.AssaginPerson, nil
}

// ResetAssaginPerson resets all changes to the "assagin_person" field.
func (m *TodoMutation) ResetAssaginPerson() {
	m.assagin_person = nil
}
...
func (m *TodoMutation) SetIsComplete(b bool) {
	m.is_complete = &b
}

// IsComplete returns the value of the "is_complete" field in the mutation.
func (m *TodoMutation) IsComplete() (r bool, exists bool) {
	v := m.is_complete
	if v == nil {
		return
	}
...
// OldIsComplete returns the old "is_complete" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldIsComplete(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) ResetIsComplete() {
	m.is_complete = nil
}
...
func (m *TodoMutation) Fields() []string {
	...
	if m.assagin_person != nil {
		fields = append(fields, todo.FieldAssaginPerson)
	}
	if m.created_at != nil {
	...
	if m.is_complete != nil {
		fields = append(fields, todo.FieldIsComplete)
	}
	if m.title != nil {
