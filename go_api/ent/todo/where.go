...
import (
	"HDYS-TTBYS/my-todo/ent/predicate"
	"time"
...
// AssaginPerson applies equality check predicate on the "assagin_person" field. It's identical to AssaginPersonEQ.
func AssaginPerson(v string) predicate.Todo {
	return predicate.Todo(sql.FieldEQ(FieldAssaginPerson, v))
}
...
func IsComplete(v bool) predicate.Todo {
	return predicate.Todo(sql.FieldEQ(FieldIsComplete, v))
}
...
// AssaginPersonEQ applies the EQ predicate on the "assagin_person" field.
func AssaginPersonEQ(v string) predicate.Todo {
	return predicate.Todo(sql.FieldEQ(FieldAssaginPerson, v))
}

// AssaginPersonNEQ applies the NEQ predicate on the "assagin_person" field.
func AssaginPersonNEQ(v string) predicate.Todo {
	return predicate.Todo(sql.FieldNEQ(FieldAssaginPerson, v))
}

// AssaginPersonIn applies the In predicate on the "assagin_person" field.
func AssaginPersonIn(vs ...string) predicate.Todo {
	return predicate.Todo(sql.FieldIn(FieldAssaginPerson, vs...))
}

// AssaginPersonNotIn applies the NotIn predicate on the "assagin_person" field.
func AssaginPersonNotIn(vs ...string) predicate.Todo {
	return predicate.Todo(sql.FieldNotIn(FieldAssaginPerson, vs...))
}

// AssaginPersonGT applies the GT predicate on the "assagin_person" field.
func AssaginPersonGT(v string) predicate.Todo {
	return predicate.Todo(sql.FieldGT(FieldAssaginPerson, v))
}

// AssaginPersonGTE applies the GTE predicate on the "assagin_person" field.
func AssaginPersonGTE(v string) predicate.Todo {
	return predicate.Todo(sql.FieldGTE(FieldAssaginPerson, v))
}

// AssaginPersonLT applies the LT predicate on the "assagin_person" field.
func AssaginPersonLT(v string) predicate.Todo {
	return predicate.Todo(sql.FieldLT(FieldAssaginPerson, v))
}

// AssaginPersonLTE applies the LTE predicate on the "assagin_person" field.
func AssaginPersonLTE(v string) predicate.Todo {
	return predicate.Todo(sql.FieldLTE(FieldAssaginPerson, v))
}

// AssaginPersonContains applies the Contains predicate on the "assagin_person" field.
func AssaginPersonContains(v string) predicate.Todo {
	return predicate.Todo(sql.FieldContains(FieldAssaginPerson, v))
}

// AssaginPersonHasPrefix applies the HasPrefix predicate on the "assagin_person" field.
func AssaginPersonHasPrefix(v string) predicate.Todo {
	return predicate.Todo(sql.FieldHasPrefix(FieldAssaginPerson, v))
}

// AssaginPersonHasSuffix applies the HasSuffix predicate on the "assagin_person" field.
func AssaginPersonHasSuffix(v string) predicate.Todo {
	return predicate.Todo(sql.FieldHasSuffix(FieldAssaginPerson, v))
}

// AssaginPersonEqualFold applies the EqualFold predicate on the "assagin_person" field.
func AssaginPersonEqualFold(v string) predicate.Todo {
	return predicate.Todo(sql.FieldEqualFold(FieldAssaginPerson, v))
}

// AssaginPersonContainsFold applies the ContainsFold predicate on the "assagin_person" field.
func AssaginPersonContainsFold(v string) predicate.Todo {
	return predicate.Todo(sql.FieldContainsFold(FieldAssaginPerson, v))
}
...
func IsCompleteEQ(v bool) predicate.Todo {
	return predicate.Todo(sql.FieldEQ(FieldIsComplete, v))
}

// IsCompleteNEQ applies the NEQ predicate on the "is_complete" field.
func IsCompleteNEQ(v bool) predicate.Todo {
	return predicate.Todo(sql.FieldNEQ(FieldIsComplete, v))
}
